...
export const regions: Region[] = [
  ...
  { id: 'atlantic-ocean', name: 'Atlantic Ocean', type: 'ocean', geo: { lon: -48, lat: 30, radius: 11 } },
  { id: 'oceania', name: 'Oceania', type: 'region', geo: { lon: 168, lat: -22, radius: 5 } },
  { id: 'caribbean-sea', name: 'Caribbean Sea', type: 'sea', geo: { lon: -66, lat: 15, radius: 6 } },
  { id: 'southern-ocean', name: 'Southern Ocean', type: 'ocean', geo: { lon: 0, lat: -62, radius: 11 } },
  { id: 'pacific-ocean', name: 'Pacific Ocean', type: 'ocean', geo: { lon: -165, lat: 8, radius: 14 } },
  ...
  { id: 'gulf-of-mexico', name: 'Gulf of Mexico', type: 'sea', geo: { lon: -90, lat: 26, radius: 6 } },
  ...
  { id: 'indian-ocean', name: 'Indian Ocean', type: 'ocean', geo: { lon: 75, lat: -28, radius: 12 } },
